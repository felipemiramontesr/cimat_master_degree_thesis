...
\subsection{Desarrollo de Sistemas Seguros con Lenguaje Unificado de Modelado}
En \cite{OMGAbout} se menciona que Unified Modeling Language (UML, Lenguaje Unificado de Modelado) ha sido creado por el \gls{OMG} un consorcio de estándares de tecnología, sin fines de lucro,  abierto e internacional, fundado en 1989. Los estándares \gls{OMG} son impulsados por proveedores, usuarios finales, instituciones académicas y agencias gubernamentales. Los grupos de trabajo de \gls{OMG} desarrollan normas de integración empresarial para una amplia gama de tecnologías y una gama más amplia de industrias. Los estándares de modelado de \gls{OMG}, incluyendo \gls{UML} y \gls{MDA} premiten un diseño visual del diseño, ejecución y mantenimiento de software y otros procesos.
